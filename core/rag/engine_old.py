...
class AstroRetriever:
    ...
    FORBIDDEN = {
        ...
        # Пример: удаляем содержащие запрещённые слова для планеты Плутон
    ...
    def search(self, query):
        ...
        # количество документов: В методе search вы берете invoke(expanded_query)[:20] документов, а затем передаете их дальше. Для LLM это огромный объем текста. Сократите до 3–5 лучших документов.
