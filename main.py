...
async def cmd_start(message: types.Message):
    welcome_text = (
        ...
        "Я готов расшифровать для вас положения планет, знаков, домов, а также дать авторскую трактовку **Лунных дней**.\n\n"
        ...
        "⚠️ **Рекомендуются задавать вопрос содержащий НЕ БОЛЕЕ одного-двух аспектов за один запрос**\n\n"
