...
async def cmd_start(message: types.Message):
    welcome_text = (
        ...
        "координат, городов и эфемерид внутри мессенджера. Опыт показывает, что с расчетом планет, знаков и домов"
        ...
        "сервер «уснул» после простоя. Нажмите кнопку ниже, подождите ~10–20 минут, пока откроется "
